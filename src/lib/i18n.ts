  ...
  am: {
    translation: {
      ...
      "aiAssistant": {
        ...
        "prompts": {
          "b1": {
            "title": "ተወዳጅ መምህር እና የጥናት ጓደኛ",
            "description": "በእርምጃ በእርምጃ ትምህርት ከምሳሌዎች እና ልምድ ጥያቄዎች ጋር",
            "prompt": "እንደ ተወዳጅ መምህር እና የጥናት ጓደኛ ልሰራ።\n\nመጀመሪያ ይጠይቁኝ፡ \"በምን ቋንቋ ልትማር ትፈልጋለህ?\" መልሴን ጠብቅ እና ትምህርቱን በዚያ ቋንቋ ቀጥል።\n\nከዚያ በኋላ ርዕስ ወይም ፋይል ስለማማር ጠይቀኝ።\n\nመመሪያዎች:\n1. የማማርበትን ነገር አጭር እና ቀላል ማጠቃለያ ስጥ።\n2. \"Next\" እንዲጻፍ አስተውለኝ እና ደረጃ 1 ጀምር።\n3. ርዕሱን ወደ ትንንሽ ንዑስ ርዕሶች ክፈል።\n4. በደረጃ 1 ብቻ ጀምር።\n5. ግልጽ እና ቀላል ማብራሪያ ስጥ።\n6. ቀላል ቃላት እና የዕለታዊ ሕይወት ምሳሌዎች ተጠቀም።\n7. ለዚያ ደረጃ ቢያንስ 3 ምሳሌዎች ስጥ።\n8. 5 የMCQ ጥያቄዎች ስጥ።\n9. ሀሳቡን በራሴ ቃላት እንድብራራ አጭር ጥያቄ ጠይቀኝ።\n10. እርምጃውን በአጭር ማጠቃለያ ጨርስ።\n\nእርምጃው ከተጠናቀቀ በኋላ ቆም እና ጠብቀኝ። \"Next\" ሲል ሲጻፍ እቀጥላለሁ።"
          },
          "b2": {
            "title": "እንደ 5 ዓመት ልጅ አብራራልኝ",
            "description": "ውስብስብ ርዕሶችን በቀላሉ መረዳት",
            "prompt": "መጀመሪያ ይጠይቁኝ፡ \"በምን ቋንቋ እንድታብራራልኝ ትፈልጋለህ?\" መልሴን ጠብቅ እና በዚያ ቋንቋ አብራራ።\n\nከዚያ [TOPIC] እንደ 5 ዓመት ልጅ በቀላሉ አብራራ፣ ቀላል ቃላትና ምሳሌዎች ተጠቀም።"
          },
          "b3": {
            "title": "የትምህርት መመሪያ ፈጣሪ",
            "description": "ለርዕሶች አጠቃላይ መመሪያ መፍጠር",
            "prompt": "መጀመሪያ ይጠይቁኝ መመሪያውን በምን ቋንቋ እንዲሆን። ከዚያ [SUBJECT/TOPIC] ለሚመለከተው ሙሉ መመሪያ ፍጠር፣ ቁልፍ ጽንሰ-ሀሳቦች፣ ትርጓሜዎችና ልምድ ጥያቄዎች አካትት።"
          },
          "b4": {
            "title": "የቤት ሥራ እገዛ",
            "description": "የቤት ሥራ ጥያቄዎችን መረዳት",
            "prompt": "መጀመሪያ የምትረዱብኝን ቋንቋ ይጠይቁ። ከዚያ ይህን የቤት ሥራ ጥያቄ እንዲበራ እገዛ ስጥ፣ እንዴት እንደሚፈታ በእርምጃ አብራራ።"
          },
          "b5": {
            "title": "የቃላት ማበልጸጊያ",
            "description": "አዲስ ቃላትን እና አጠቃቀማቸውን ማማር",
            "prompt": "በምን ቋንቋ እንዲታሰር ይጠይቁኝ። ከዚያ ከ[SUBJECT] ጋር የተያያዙ 10 ቁልፍ ቃላት ስጥ፤ ትርጓሜ፣ ተግባራዊ ምሳሌ እና የማስታወሻ ዘዴ አካትት።"
          },
          "i1": {
            "title": "ባለሙያ መምህር እና መመሪያ",
            "description": "በተዋቀረ መንገድ ከቴክኒክ ሐሳቦች ጋር ትምህርት",
            "prompt": "እንደ ባለሙያ መምህር እና መመሪያ ልሰራ። ቋንቋውን ምረጥ እና ትምህርቱን በዚያ ቋንቋ ቀጥል። ርዕሱን ወደ ሎጂካዊ እርምጃዎች ክፈል፣ የግልጽ እና የተዋቀረ ማብራሪያ ስጥ፣ ምሳሌዎችን እና MCQ አካትት።"
          },
          "i2": {
            "title": "የመግለጫ እቅድ ጀነሬተር",
            "description": "የተዋቀረ የመግለጫ እቅድ ፍጠር",
            "prompt": "መጀመሪያ ቋንቋ ምረጥ። ለ[TOPIC] ዝርዝር የመግለጫ እቅድ ፍጠር፣ ቴይዚስ፣ 3-5 ዋና ነጥቦች እና መደረሻ አካትት።"
          },
          "i3": {
            "title": "የጽንሰ ሀሳብ አገናኝ",
            "description": "ተያያዥ ሀሳቦችን መገናኘት",
            "prompt": "[CONCEPT A] እና [CONCEPT B] በ[SUBJECT] ውስጥ እንዴት እንደሚገናኙ አብራራ፣ ግንኙነቶች እና ከእውነተኛ ዓለም ምሳሌዎች አቀርብ።"
          },
          "i4": {
            "title": "የልምድ ፈተና ፈጣሪ",
            "description": "የልምድ ጥያቄዎች መፍጠር",
            "prompt": "ቋንቋ ምረጥ። ለ[SUBJECT/TOPIC] 10 ጥያቄዎች ያሉትን ልምድ ፈተና ፍጠር፣ MCQ 5፣ አጭር መልስ 3፣ ኤሴይ 2 እና መልስ ቁልፍ አካትት።"
          },
          "i5": {
            "title": "የምርምር ረዳት",
            "description": "ርዕሶችን ማስረጃ እና ማደራጀት",
            "prompt": "[TOPIC] ላይ እገዛ ስጥ፤ ዋና አካላት፣ ጥያቄዎች፣ ምንጮች እና የመደራጀት መንገዶችን አቀርብ።"
          },
          "a1": {
            "title": "ባለሞያ ፕሮፌሰር እና መንገድ መሪ",
            "description": "በዝርዝር ከላቀ ሐሳቦች ጋር ማስተማር",
            "prompt": "እንደ ፕሮፌሰር እና መንገድ መሪ ልሰራ። ቋንቋ ምረጥ፣ ርዕስ እና ፋይል ጠይቅ፣ አስተማሪ እርምጃዎች ክፈል፣ ጥልቅ ነገር ግን ግልጽ ማብራሪያ እና ከእውነተኛ ዓለም ምሳሌዎች አቀርብ።"
          },
          "a2": {
            "title": "የአስተያየት ትንታኔ መመሪያ",
            "description": "ጽሁፎችን እና ክርክሮችን በትክክል መተንተን",
            "prompt": "[TEXT/ARGUMENT] በትክክል ተንትን፤ ቴይዚስ፣ ጥንካሬ/ድክመቶች፣ ሎጂካዊ ስህተቶች፣ ማስረጃ ጥራት እና አማራጭ እይታዎች አቀርብ።"
          },
          "a3": {
            "title": "ሶክራቲክ መምህር",
            "description": "በመምረት ጥያቄዎች የሚመራ ትምህርት",
            "prompt": "ለ[SUBJECT/TOPIC] እንደ ሶክራቲክ መምህር ስራ፤ ቀጥተኛ መልስ አትስጥ፣ በጥያቄ በመመራት እንዲያገኙ አድርግ።"
          },
          "a4": {
            "title": "የቴይዚስ ልማት",
            "description": "ጠንካራ ቴይዚስ መገንባት",
            "prompt": "[TOPIC] ላይ ጠንካራ ቴይዚስ እንዴት እንደሚገነባ መመሪያ ስጥ፣ አቅጣጫ መከታተያ እና ማሻሻያ አካትት።"
          },
          "admin1": {
            "title": "የMCQ ጀነሬተር (ለአስተዳዳሪዎች ብቻ)",
            "description": "ከመልሶች እና ማብራሪያዎች ጋር የፈተና ጥያቄዎች መፍጠር",
            "prompt": "እንደ ባለሙያ የፈተና ጥያቄ ጀነሬተር ስራ።\n\nመጀመሪያ ይጠይቁኝ፡ \"ጥያቄዎቹን በምን ቋንቋ ትፈልጋለህ?\" መልሴን ጠብቅ እና ሁሉንም ጥያቄዎች በዚያ ቋንቋ አቀርብ።\n\nርዕስ:\n[ርዕስ አስገባ]\n\nየከባድነት ደረጃ:\n[ቀላል / መካከለኛ / ከባድ]\n\nጥያቄዎች ብዛት:\n[ቁጥር አስገባ]\n\nመመሪያዎች:\n1. በርዕሱ መሠረት ጥራታማ MCQ ፍጠር።\n2. እያንዳንዱ ጥያቄ 4 አማራጮች (A, B, C, D) ይኑሩ።\n3. ትክክለኛውን መልስ በ* በመጨረሻ ምልክት አድርግ።\n4. ከእያንዳንዱ ጥያቄ በኋላ አጭር ማብራሪያ ስጥ።\n5. ግልጽ እና ቀላል ቋንቋ ተጠቀም።\n6. ጥያቄዎችን አትድገም።\n7. ለተማሪዎች ተስማሚ አድርግ።\n\nቅርጸ-ተከታታይ:\n\n1. ጥያቄ?\nA. አማራጭ\nB. አማራጭ\nC. ትክክለኛ መልስ *\nD. አማራጭ\n\nማብራሪያ: መልሱ ለምን እንደሆነ አጭር ማብራሪያ ጻፍ።"
          }
        }
      },
      "mindMap": {
